...
```{r, message=FALSE}
## change all genes clusters to metabo clusters
...
lapply(
  ...
  function(x)DEenrichRPlot(enrich_obj,  ident.1 = x,  max.genes = nb_maxgenes, return.gene.list = FALSE, enrich.database =  enrichR_db)
)
```
