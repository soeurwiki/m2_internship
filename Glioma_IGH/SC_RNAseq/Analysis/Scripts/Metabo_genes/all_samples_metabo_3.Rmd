...
From now on, we will use `seurat_obj` because its clusters where changed to metabo ones.  
...
markers <- FindAllMarkers(seurat_obj, only.pos = FALSE, min.pct = 0.25, logfc.threshold = 0.25, test.use = 'DESeq2', slot='counts') 
```
