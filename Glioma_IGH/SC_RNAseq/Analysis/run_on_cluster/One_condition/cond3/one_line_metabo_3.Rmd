---
title: "METABO -- QC & Markers of clusters for one sample"
author: "ATIA Safiya"
date: "2023-07-26"
params:
  samp: "samp"
...
```{r}
metabo_obj <- readRDS(file = paste0('./Lucille/results/rds/samples/', samp, '_FindNeighbors_metabo.rds'))
...
cluster.markers <- FindAllMarkers(metabo_obj, assay = "SCT", verbose=FALSE)
```
...
### save markers lists
```{r}
saveRDS(cluster.markers, file = paste0("./Lucille/results/html/", samp, "/", samp, "_cluster.markers_metabo.rds"))
```

# Save seurat object  
```{r}
saveRDS(metabo_obj, file = paste0("./Lucille/results/rds/samples/", samp, "_Markers_metabo.rds"))
```
