---
title: "METABO -- Clusters annotations for one sample"
author: "ATIA Safiya"
date: "2023-07-26"
params:
  samp: "samp"
...
```{r}
metabo_obj <- readRDS(file = paste0('./Lucille/results/rds/samples/', samp, '_Mca_metabo.rds'))
...
```
```{r, echo=FALSE}
HGT_brain_signatures <- readRDS( paste0('./Lucille/results/rds/samples/', samp, '_HGT_brain_signatures_metabo.rds'))
```
...
```{r}
saveRDS(metabo_obj, file = paste0("./Lucille/results/rds/samples/", samp, "_Clusters_metabo.rds"))
```