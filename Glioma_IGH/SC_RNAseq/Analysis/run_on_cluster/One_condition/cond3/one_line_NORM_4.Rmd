---
title: "Clusters annotations for one sample [Normalized]"
author: "ATIA Safiya"
date: "2023-07-26"
params:
  samp: "samp"
...
```{r}
seurat_obj <- readRDS(file = paste0('./Lucille/results/rds/samples/', samp, '_Mca.rds'))
...
```
```{r, echo=FALSE}
HGT_brain_signatures <- readRDS( file= paste0('./Lucille/results/rds/samples/', samp, '_HGT_brain_signatures.rds'))
```
...
# Save seurat object  
```{r}
saveRDS(seurat_obj, file = paste0("./Lucille/results/rds/samples/", samp, "_Clusters.rds"))
```
