---
title: "Defining clusters for one sample [Normalized]"
author: "ATIA Safiya"
date: "2023-07-26"
params:
  samp: "samp"
...
```{r}
seurat_obj <- RunTSNE(seurat_obj, reduction = "pca", dims=1:pc,seed.use = saved.seed, check_duplicates = FALSE, verbose = FALSE)
...
## Save seurat object  
```{r}
saveRDS(seurat_obj, file = paste0("./Lucille/results/rds/samples/", samp, "_FindNeighbors.rds"))
```
