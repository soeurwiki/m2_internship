---
title: "Defining clusters for one line [Normalized]"
author: "ATIA Safiya"
date: "2023-07-26"
params:
  sample: "sample"
...
diff <- readRDS(file = paste0('./results/rds/samples/norm_', line, '_diff.rds'))
diff

prolif <- readRDS(file = paste0('./results/rds/samples/norm_', line, '_prolif.rds'))
prolif
```
...
```{r}
seurat_obj <- merge(diff, y = prolif, 
                    add.cell.ids = c( paste0(line, "_diff"), paste0(line, "_diff")) )
...
# Save seurat object  
```{r}
saveRDS(seurat_obj, file = paste0("./results/rds/samples/", line, "/line_", sample, "_FindNeighbors.rds"))
```
